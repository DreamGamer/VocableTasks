    ...
    return (
        <ScrollView>
            <View style={styles.form}>
                <Formik initialValues={{ wordENG: "", wordDE: "" }} validationSchema={yupSchema} onSubmit={async (values, actions) => {
                    ...
                    {(formikProps) => (
                        <View>
                            <Label title="English:" />
                            <Input onBlur={formikProps.handleBlur("wordENG")} placeholder="Enter the english Word" onChangeText={formikProps.handleChange("wordENG")} value={formikProps.values.wordENG} disabled={isLoading ? false : true} />
                            <Text style={styles.errorText}>{formikProps.touched.wordENG && formikProps.errors.wordENG}</Text>

                            <Label title="German:" />
                            <Input onBlur={formikProps.handleBlur("wordDE")}  placeholder="Enter the german Word" onChangeText={formikProps.handleChange("wordDE")} value={formikProps.values.wordDE} disabled={isLoading ? false : true} />
